...
python3 transfer_learning.py --max_iter=$MAX_ITER --data_folder=data/numpy_bitmap_3/ --transfer_model=InceptionV3 --experiment_name="transfer_learning_with_InceptionV3_3_classes" --tune_source_model=True "$@"
